# Spider Sitemap Generator

Crawl websites and generate visual, interactive sitemaps with XML export using [Spider Cloud](https://spider.cloud) — the fastest web crawling infrastructure.

[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fspider-rs%2Fspider-sitemap-generator&env=NEXT_PUBLIC_SUPABASE_URL,NEXT_PUBLIC_SUPABASE_ANON_KEY)

**Live Demo:** [https://sitemap-generator.spider.cloud](https://sitemap-generator.spider.cloud)
...
```bash
git clone https://github.com/spider-rs/spider-sitemap-generator.git
cd spider-sitemap-generator
```
